...
export KERNEL_PATH
$(call inherit-product, device/sprd/roc1/ud710_2h10u/ud710_2h10u_Base.mk)
...
TARGET_BOOTLOADER_BOARD_NAME := ud710_2h10u
CHIPRAM_DEFCONFIG := ud710_2h10u
UBOOT_DEFCONFIG := ud710_2h10u
UBOOT_TARGET_DTB := ud710_2h10u

PRODUCT_NAME := ud710_2h10u_native
PRODUCT_DEVICE := ud710_2h10u
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ud710_2h10u.xml:$(PRODUCT_OUT)/ud710_2h10u.xml
...
PRODUCT_PROPERTY_OVERRIDES += \
ro.vendor.jl.ota.version=1.0.0001.021

#internal software version
SOFTWARE_INTERNAL_VERSION :=1.0.0001.021
