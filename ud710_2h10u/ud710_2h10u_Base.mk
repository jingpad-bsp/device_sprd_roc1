...
# Aw87519 config file
PRODUCT_COPY_FILES += \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_fm_0.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_fm_0.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_off_0.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_off_0.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_rcv_0.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_rcv_0.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_voice_0.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_voice_0.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_music_0.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_music_0.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_fm_1.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_fm_1.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_off_1.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_off_1.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_rcv_1.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_rcv_1.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_voice_1.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_voice_1.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_pid_59_music_1.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_pid_59_music_1.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_vmax_0.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_vmax_0.bin \
	device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/aw87xxx_vmax_1.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87xxx_vmax_1.bin
#Aw stk3
PRODUCT_COPY_FILES += \
 device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/awinic_params.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/awinic_params.bin \
 device/sprd/roc1/ud710_2h10u/rootdir/system/etc/audio_params/awinic/awinic.audio.effect.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/awinic.audio.effect.so

#elan tp mmi

PRODUCT_COPY_FILES += \
 device/sprd/roc1/ud710_2h10u/rootdir/system/etc/tp/elanchip_3542_raw.csv:$(TARGET_COPY_OUT_VENDOR)/firmware/elanchip_3542_raw.csv
