...
export KERNEL_PATH
$(call inherit-product, device/sprd/roc1/ud710_9h10u/ud710_9h10u_Base.mk)
PLATDIR := device/sprd/roc1
TARGET_BOARD := ud710_9h10u
...
TARGET_BOOTLOADER_BOARD_NAME := ud710_9h10u
CHIPRAM_DEFCONFIG := ud710_9h10u
UBOOT_DEFCONFIG := ud710_9h10u
UBOOT_TARGET_DTB := ud710_9h10u

PRODUCT_NAME := ud710_9h10u_native
PRODUCT_DEVICE := ud710_9h10u
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := ud710_9h10u_native
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ud710_9h10u.xml:$(PRODUCT_OUT)/ud710_9h10u.xml
