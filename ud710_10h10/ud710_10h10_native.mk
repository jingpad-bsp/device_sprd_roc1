...
export KERNEL_PATH
$(call inherit-product, device/sprd/roc1/ud710_10h10/ud710_10h10_Base.mk)
PLATDIR := device/sprd/roc1
TARGET_BOARD := ud710_10h10
...
TARGET_BOOTLOADER_BOARD_NAME := ud710_10h10
CHIPRAM_DEFCONFIG := ud710_10h10
UBOOT_DEFCONFIG := ud710_10h10
UBOOT_TARGET_DTB := ud710_10h10

PRODUCT_NAME := ud710_10h10_native
PRODUCT_DEVICE := ud710_10h10
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := ud710_10h10_native
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ud710_10h10.xml:$(PRODUCT_OUT)/ud710_10h10.xml
