...
export KERNEL_PATH
$(call inherit-product, device/sprd/roc1/ud710_7h10/ud710_7h10_Base.mk)
PLATDIR := device/sprd/roc1
TARGET_BOARD := ud710_7h10
...
CHIPRAM_DEFCONFIG := ud710_7h10
UBOOT_DEFCONFIG := ud710_7h10
UBOOT_TARGET_DTB := ud710_7h10

PRODUCT_NAME := ud710_7h10_native
PRODUCT_DEVICE := ud710_7h10
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := ud710_7h10_native
...
BOARD_FINGERPRINT_CONFIG := microarray_s809
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ud710_7h10.xml:$(PRODUCT_OUT)/ud710_7h10.xml
...
PRODUCT_SOCKO_KO_LIST := \
    ...
    $(BSP_KERNEL_MODULES_OUT)/nt36xxx_ts.ko \
...
#multi camera
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.res.multi.camera=RES_MULTI_12M
#multi camera fullsize
...
#ultra res 4in1 capture
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.back.high.res.zsl=1
