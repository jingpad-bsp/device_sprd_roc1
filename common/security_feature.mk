...
ifeq ($(strip $(BOARD_NOT_VERIFY_MODEM)), true)
NOT_VERIFY_MODEM_FLAG := true
endif
#SANSA|SPRD|NONE
...
BOARD_AVB_MAKE_VBMETA_IMAGE_ARGS+=--chain_partition l_agdsp:8:$(BOARD_AVB_KEY_PATH_MODEMIMAGE_PUB)
BOARD_AVB_MAKE_VBMETA_IMAGE_ARGS+=--chain_partition l_pmsys:9:$(BOARD_AVB_KEY_PATH_MODEMIMAGE_PUB)
...
include vendor/sprd/partner/chipone/sharkl7332A/chipone_sharkl7332A.mk
endif
ifeq ($(strip $(BOARD_FINGERPRINT_CONFIG)), goodix)
include vendor/sprd/partner/goodix/roc1/goodix_roc1.mk
endif

ifeq ($(strip $(BOARD_FINGERPRINT_CONFIG1)), silead)
include vendor/sprd/partner/silead/silead_roc1.mk
endif

ifeq ($(strip $(BOARD_FINGERPRINT_CONFIG)), sunwave_hs)
include vendor/sprd/partner/sunwave/roc1_hs/sunwave_roc1_hs.mk
endif

ifeq ($(strip $(BOARD_FINGERPRINT_CONFIG)), microarray_s809)
include vendor/sprd/partner/microarray/roc1_s809/microarray_s809.mk
endif

ifeq ($(strip $(BOARD_FINGERPRINT_CONFIG)), microarray)
include vendor/sprd/partner/microarray/roc1/microarray_roc1.mk
endif
...
#ifaa
#
#ifaa.default & libifaacheck are closed source, while ifaa default to be closed, they need to be build in idh by default.
#
PRODUCT_PACKAGES += \
    ifaa.default \
    libifaacheck
