...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/system/usr/keylayout/synaptics_tcm.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/synaptics_tcm.kl \
    $(LOCAL_PATH)/rootdir/system/usr/keylayout/sprdkbd.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/sprdkbd.kl \
    ...
    $(LOCAL_PATH)/rootdir/system/usr/idc/synaptics_tcm.idc::$(TARGET_COPY_OUT_VENDOR)/usr/idc/synaptics_tcm.idc \
    $(LOCAL_PATH)/rootdir/system/usr/idc/ssd20xx.idc::$(TARGET_COPY_OUT_VENDOR)/usr/idc/ssd20xx.idc \
    $(LOCAL_PATH)/rootdir/system/usr/idc/nt36xxx_ts.idc::$(TARGET_COPY_OUT_VENDOR)/usr/idc/nt36xxx_ts.idc \
    $(LOCAL_PATH)/rootdir/system/usr/idc/focaltech_spi_ts.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/focaltech_spi_ts.idc \
    $(LOCAL_PATH)/rootdir/system/usr/idc/focaltech_ts_T7510.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/focaltech_ts_T7510.idc \
    $(LOCAL_PATH)/rootdir/system/media/engtest_sample.pcm:system/media/engtest_sample.pcm \
    $(LOCAL_PATH)/rootdir/system/vendor/firmware/goodix_cfg_group.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/goodix_cfg_group.bin
...
#PRODUCT_COPY_FILES += \
    vendor/sprd/external/drivers/gpu/rogue/driver/build/linux/roc1_android/pvrsrvkm.ko:vendor/lib/modules/pvrsrvkm.ko
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/power/ddr/bm/tool/roc1_cm4_disable_smart_light.bin:/vendor/bin/power/ddr/bm/tool/roc1_cm4_disable_smart_light.bin
PRODUCT_COPY_FILES += \
...
ifeq (ufs,$(strip $(BOARD_MEMORY_TYPE)))
   RECOVERY_TMPFSDATA_FSTAB_MEMORY_SUFFIX := ufs.
   UEVENTD_FSTAB_MEMORY_SUFFIX1 := ufs.
else
   RECOVERY_TMPFSDATA_FSTAB_MEMORY_SUFFIX := emmc.
   UEVENTD_FSTAB_MEMORY_SUFFIX1 := emmc.
endif
UEVENTD_FSTAB_MEMORY_SUFFIX := $(UEVENTD_FSTAB_MEMORY_SUFFIX1)

PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/root/ueventd.$(UEVENTD_FSTAB_MEMORY_SUFFIX)common.rc:recovery/root/ueventd.$(TARGET_BOARD).rc \
    $(LOCAL_PATH)/recovery/recovery.$(RECOVERY_TMPFSDATA_FSTAB_MEMORY_SUFFIX)tmpfsdata.fstab:recovery/root/system/etc/recovery.tmpfsdata.fstab
...
ifneq ($(strip $(TARGET_AICORE_VERSION)),)
    DEVICE_MANIFEST_FILE += $(PLATCOMM)/manifest_npu.xml
    $(call inherit-product-if-exists, vendor/sprd/modules/NPU/imgtec/device-imgtec-nna.mk)
    PRODUCT_PROPERTY_OVERRIDES += \
        persist.vendor.npu.version=1
endif #ifneq ($(strip $(TARGET_AICORE_VERSION)),)
...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    persist.vendor.display.faceid=1
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/system/etc/init/poweroff.rc:system/etc/init/poweroff.rc
