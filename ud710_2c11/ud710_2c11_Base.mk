...
AUDIO_SMART_PA_TYPE_AWINIC :=aw87519

ifeq ($(strip $(AUDIO_SMART_PA_TYPE_AWINIC)),aw87519)
    PRODUCT_COPY_FILES += \
    $(ROOTDIR)/system/etc/audio_params/aw87519l_spk.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw87519l_spk.bin
endif
...
#mag sensor cali
PRODUCT_COPY_FILES += \
    vendor/sprd/modules/sensors/libsensorhub/ConfigSensor/calibration/dynamic_call/ud710_2c11_sc7a20.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/EXEC_CALIBRATE_MAG_IMAGE
