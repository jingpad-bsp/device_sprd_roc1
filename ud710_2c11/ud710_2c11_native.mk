...
export KERNEL_PATH
$(call inherit-product, device/sprd/roc1/ud710_2c11/ud710_2c11_Base.mk)
PLATDIR := device/sprd/roc1
TARGET_BOARD := ud710_2c11
...
TARGET_BOOTLOADER_BOARD_NAME := ud710_2c11
CHIPRAM_DEFCONFIG := ud710_2c11
UBOOT_DEFCONFIG := ud710_2c11
UBOOT_TARGET_DTB := ud710_2c11

PRODUCT_NAME := ud710_2c11_native
PRODUCT_DEVICE := ud710_2c11
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := ud710_2c11_native
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ud710_2c11.xml:$(PRODUCT_OUT)/ud710_2c11.xml
...
PRODUCT_SOCKO_KO_LIST := \
    ...
    $(BSP_KERNEL_MODULES_OUT)/fpsensor.ko\
