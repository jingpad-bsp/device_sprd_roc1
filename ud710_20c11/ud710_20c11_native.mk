...
export KERNEL_PATH
$(call inherit-product, device/sprd/roc1/ud710_20c11/ud710_20c11_Base.mk)
...
TARGET_BOOTLOADER_BOARD_NAME := ud710_20c11
CHIPRAM_DEFCONFIG := ud710_20c11
UBOOT_DEFCONFIG := ud710_20c11
UBOOT_TARGET_DTB := ud710_20c11

PRODUCT_NAME := ud710_20c11_native
PRODUCT_DEVICE := ud710_20c11
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := ud710_20c11_native
...
BOARD_FINGERPRINT_CONFIG := chipone
...
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.opticszoom.cali.mode=0
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ud710_20c11.xml:$(PRODUCT_OUT)/ud710_20c11.xml
...
PRODUCT_SOCKO_KO_LIST := \
    $(BSP_KERNEL_MODULES_OUT)/flash_ic_aw3642.ko \
    ...
    $(BSP_KERNEL_MODULES_OUT)/focaltech_spi_19b_ts.ko\
...
PRODUCT_SOCKO_KO_LIST += $(BSP_KERNEL_MODULES_OUT)/fpsensor.ko
endif

ifeq ($(strip $(BOARD_FINGERPRINT_CONFIG)), sunwave_hs)
PRODUCT_SOCKO_KO_LIST += $(BSP_KERNEL_MODULES_OUT)/hs_sunwave_fp.ko
endif
