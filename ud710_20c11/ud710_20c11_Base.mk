...
PRODUCT_COPY_FILES += \
    ...
    $(ROOTDIR)/system/etc/audio_policy_config/primary_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/primary_audio_policy_configuration.xml \
    $(ROOTDIR)/system/etc/audio_params/aw881xx/aw881xx_pid_03_rcv_cfg.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw881xx_pid_03_rcv_cfg.bin \
    $(ROOTDIR)/system/etc/audio_params/aw881xx/aw881xx_pid_03_rcv_fw.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw881xx_pid_03_rcv_fw.bin \
    $(ROOTDIR)/system/etc/audio_params/aw881xx/aw881xx_pid_03_rcv_reg.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw881xx_pid_03_rcv_reg.bin \
    $(ROOTDIR)/system/etc/audio_params/aw881xx/aw881xx_pid_03_spk_cfg.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw881xx_pid_03_spk_cfg.bin \
    $(ROOTDIR)/system/etc/audio_params/aw881xx/aw881xx_pid_03_spk_fw.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw881xx_pid_03_spk_fw.bin \
    $(ROOTDIR)/system/etc/audio_params/aw881xx/aw881xx_pid_03_spk_reg.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/aw881xx_pid_03_spk_reg.bin
endif
endif
